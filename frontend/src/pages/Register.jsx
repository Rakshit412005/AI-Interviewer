      ...
      <div className='w-full max-w-md bg-white p-6 sm:p-10 border border-gray-200 rounded-2xl shadow-xl' >
        ...
        <form onSubmit={onSubmit} className='grid grid-cols-1 gap-4'>
          <div className='space-y-1'>
            ...
            <input type="text" name="name" value={name} className='w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 outline-none transition-all ' placeholder='Enter your full name' onChange={onChange} required />
          </div>
          <div className='space-y-1'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            ...
            <div className='space-y-1'>
              ...
              <input type="password" name="password2" value={password2} className='w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 outline-none transition-all ' placeholder='Confirm password' onChange={onChange} required />
            </div>
          </div>
