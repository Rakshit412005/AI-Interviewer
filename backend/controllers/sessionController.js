...
const evaluateAnswerAsync = async (
  ...
  try {
    ...
    console.log("USER ANSWER:", transcription);
    ...
    // mark this question as finished even if Gemini failed
    question.userAnswerText = transcription;
    question.userSubmittedCode = code || "";
    question.technicalScore = 0;
    question.confidenceScore = 0;
    question.aiFeedback = `AI evaluation failed: ${error.message}`;
    question.idealAnswer = "Unavailable because AI evaluation failed.";
    question.isEvaluated = true;
...
const endSession = asyncHandler(async (req, res) => {
  ...
  if (pendingQuestions.length > 0) {
    pendingQuestions.forEach((q) => {
      ...
      q.confidenceScore = 0;
      q.aiFeedback =
        "AI evaluation did not complete. This question was closed while processing.";
      q.idealAnswer = "Unavailable because evaluation was not completed.";
      q.isEvaluated = true;
    });
  }
